      ...
      <Container size="default" className="space-y-12">
        ...
        <div className="space-y-8 text-neutral-700 font-light leading-relaxed border-t border-[#EAE5DE] pt-8">
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-[#1A1A1A]">1. Commission Acceptance</h3>
            <p className="text-sm">
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-[#1A1A1A]">2. Vendor & Artisan Contracts</h3>
            <p className="text-sm">
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-[#1A1A1A]">3. Force Majeure & Transfers</h3>
            <p className="text-sm">
