      ...
      <Container size="default" className="space-y-12">
        ...
        <div className="space-y-8 text-neutral-700 font-light leading-relaxed border-t border-linen pt-8">
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-ink">1. Confidentiality Commitment</h3>
            <p className="text-sm">
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-ink">2. Information Collection</h3>
            <p className="text-sm">
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-2xl text-ink">3. Photography & Media Discretion</h3>
            <p className="text-sm">
